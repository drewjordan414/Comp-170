...
if __name__ == '__main__':
    ...
    send_to = input(color('[?] Enter Address of Link [You are Sending to Victim]: ')).rstrip()
    print(color("[+] Send_To Link: " + send_to, "green"))

    connect_to = input(color('[?] Enter Address of Link [Your Link will be Connecting to..]: ')).rstrip()
    ...
    print(color("[?]\n\nNote: I know a few of the Exploits do not work\n      due to Updated Browsers and stuff...\n\nTip: Change Payload or Images Address to your Connect_to Address with Port 80 \n\tExample: ", "blue"))
    print(color("\tFROM Image URL: http://0.0.0.0:3000/adobe/flash_update.png", "red"))
    print(color("\tTO Image URL: http://{}:80/adobe/flash_update.png".format(connect_to), "green"))
    print(color('\nHappy Hacking!!!\nHave a Problem or Tip? Contact: https://github.com/stormshadow07', "green"))
